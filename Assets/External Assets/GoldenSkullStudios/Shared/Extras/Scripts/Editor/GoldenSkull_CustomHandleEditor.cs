...
public class GoldenSkull_CustomHandleEditor : Editor
{
    ...
    private void newHandle()
    {
        ...
        var fmh_57_85_638997627000332305 = Quaternion.Euler(obj.rotation); obj.groundPos = Handles.FreeMoveHandle(obj.groundPos+ freemoveHandleOffset, obj.handleUIScale*0.1f, Vector3.one, Handles.DotHandleCap)- freemoveHandleOffset;
